...
u_int __attribute__((__section__(".stack_tsk4"))) stack4[DEFAULT_STACK_SIZE+DEFAULT_STACK_SIZE];
u_int __attribute__((__section__(".stack_tskrs"))) stack_rs[DEFAULT_STACK_SIZE];
...
const TCB TCB_const_list[] = 
  {
    ...
    *******************************************************************/
   {
     SREG(stack_rs),                       /* Stack_register          */
     FREG(stack_rs),                       /* Frame_register          */
     RS_Drv,                               /* StartAddress            */
     stack_rs,                             /* StackAddress            */
     sizeof(stack_rs),                     /* StackSize               */
     RS_DRV_ID,                            /* TaskID                  */
     DRV_RS_PRIO,                          /* Priority                */
     NONE,                                 /* EventWaited             */
     NONE,                                 /* EventReceived           */
     READY,                                /* State                   */
     EXTENDED,                             /* Type                    */
