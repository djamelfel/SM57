...
TASK(TASK0) 
{
  ...
  SetRelAlarm(ALARM_TSK0, 500, 500);
  ...
  while(1)
  {
    ...
    LATBbits.LATB0 = ~LATBbits.LATB0;	// inversion de l'état de la LED
    if(LATBbits.LATB0) SetEvent(TASK1_ID, TASK1_EVENT); // divise par 2 la F
  }
}
